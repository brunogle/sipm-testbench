...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "OUT_EXTRA" -parent ${Page_0}
...
proc update_PARAM_VALUE.OUT_EXTRA { PARAM_VALUE.OUT_EXTRA } {
	# Procedure called to update OUT_EXTRA when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.OUT_EXTRA { PARAM_VALUE.OUT_EXTRA } {
	# Procedure called to validate OUT_EXTRA
	return true
}
...
proc update_MODELPARAM_VALUE.OUT_EXTRA { MODELPARAM_VALUE.OUT_EXTRA PARAM_VALUE.OUT_EXTRA } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.OUT_EXTRA}] ${MODELPARAM_VALUE.OUT_EXTRA}
}
